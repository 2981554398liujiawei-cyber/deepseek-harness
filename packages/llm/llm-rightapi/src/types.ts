/**
 * RightAPI chat-completions wire format (OpenAI-compatible). Types only.
 *
...
export interface WireRequest {
  ...
  /** Reasoning effort (OpenAI-compatible; only when an effort was requested). */
 ...
 * null) on tool-call-only turns 鈥?some gateways reject null 鈥?and sends null
...
export interface WireAssistantMessage {
   ...
   * save tokens). See guides/thinking_mode.mdx 搂 Tool Calls.
   */
