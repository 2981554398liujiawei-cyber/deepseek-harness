...
import promptEnhancerRemote from '@deepseek-ai/dsh-prompt-enhancer/remote'
...
export type {} from '@deepseek-ai/dsh-prompt-enhancer/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote, promptEnhancerRemote,
    ]) {
